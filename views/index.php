	...
	<form method="post">
		...
		<?php
			if (isset($_POST['send'])){
				...
				$mail_username="florencia.juarez.159@gmail.com";//Correo electronico saliente ejemplo: tucorreo@gmail.com
				$mail_userpassword="ojosdevidrio";//Tu contraseña de gmail
				$mail_addAddress="florencia.juarez.159@gmail.com";//correo electronico que recibira el mensaje
